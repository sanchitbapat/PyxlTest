...
global $optimizer;?>
        ...
        <div id="ast_nextprev" class="navigation">
            ...
            <?php $prevPost = get_previous_post(true); if($prevPost) {?>
                ...
                <?php previous_post_link('%link','<i class="fa fa-angle-left"></i>'.$prevthumbnail.''.__('Previous Post','optimizer').'<br><span>%title</span>', TRUE); ?>
            ...
            <?php $nextPost = get_next_post(true); if($nextPost) { ?>
                ...
                <?php next_post_link('%link','<i class="fa fa-angle-right"></i>'.$nextthumbnail.''.__('Next Post','optimizer').'<br><span>%title</span>', TRUE); ?>
